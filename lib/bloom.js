...
// ============================================================
// Guía SIMPLIFICADA para la materia de INGLÉS.
//
// Los alumnos apenas están aprendiendo el idioma, así que los niveles 2 en
// adelante se calibran MÁS FÁCILES (menos carga cognitiva, vocabulario básico,
// una sola idea por pregunta) para no fatigarlos. El enunciado, la respuesta de
// referencia y la pista se piden EN ESPAÑOL (ver lib/llm.js); solo las palabras
// o frases en inglés que se deben aprender van en inglés.
// ============================================================
// Para incentivar el RECUERDO ACTIVO, los niveles 2, 3 y 4 piden al alumno que
// JUSTIFIQUE su respuesta (por qué es correcta / qué regla usó). El nivel 1 se
// deja como reconocimiento puro para no sobrecargar a quien recién empieza.
export const BLOOM_LABELS_INGLES = {
  1: 'Recordar y Comprender — reconocer el significado de palabras y frases cortas de uso común en inglés, y traducir palabras o frases sencillas',
  2: 'Aplicar (nivel sencillo) — completar o formar UNA oración corta y sencilla usando correctamente una palabra o frase básica en inglés, y justificar brevemente por qué esa es la forma correcta (la pregunta debe pedir la justificación)',
  3: 'Evaluar (nivel sencillo) — elegir la opción correcta entre opciones sencillas y SIEMPRE justificar por qué se elige esa opción (la pregunta debe pedir explícitamente la justificación)',
  4: 'Crear (nivel sencillo) — escribir una o dos oraciones cortas y simples en inglés usando una palabra o frase dada, y explicar brevemente por qué las escribió así o qué regla aplicó',
};
